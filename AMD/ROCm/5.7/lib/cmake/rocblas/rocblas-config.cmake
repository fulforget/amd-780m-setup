...
set_and_check(rocblas_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)

set_and_check(rocblas_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include)
...
set_and_check(rocblas_TARGET_FILE ${PACKAGE_PREFIX_DIR}/lib/cmake/rocblas/rocblas-targets.cmake)

find_dependency(hip)

include(${rocblas_TARGET_FILE})
