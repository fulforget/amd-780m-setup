...
foreach(_expectedTarget hiprtc::hiprtc)
...
file(TO_CMAKE_PATH "${HIP_PATH}" _IMPORT_PREFIX)
...
file(GLOB CONFIG_FILES "${_DIR}/hiprtc-targets-*.cmake")
...
# SWDEV-368048 - skip checking dlls since the dlls are copied to system32 folder
