...
set_and_check(rocthrust_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)

set_and_check(rocthrust_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include)
...
set_and_check(rocthrust_TARGET_FILE ${PACKAGE_PREFIX_DIR}/lib/cmake/rocthrust/rocthrust-targets.cmake)
