...
# from rocalution-config.cmake.in
...
set_and_check(rocalution_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)

set_and_check(rocalution_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include)
...
set_and_check(rocalution_TARGET_FILE ${PACKAGE_PREFIX_DIR}/lib/cmake/rocalution/rocalution-targets.cmake)

find_dependency(HIP)

find_dependency(OpenMP)

include(${rocalution_TARGET_FILE})

set(rocalution_LIBRARIES roc::rocalution)

set(rocalution_LIBRARY roc::rocalution)
