...
set_and_check(hiprand_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)

set_and_check(hiprand_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include)
...
set_and_check(hiprand_TARGET_FILE ${PACKAGE_PREFIX_DIR}/lib/cmake/hiprand/hiprand-targets.cmake)

find_dependency(hip)

include(${CMAKE_CURRENT_LIST_DIR}/hiprand-fortran-config.cmake)

include(${hiprand_TARGET_FILE})

set(hiprand_LIBRARIES hip::hiprand)

set(hiprand_LIBRARY hip::hiprand)
