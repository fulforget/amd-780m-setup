...
set_and_check(rocRAND_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)

set_and_check(rocRAND_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include)
...
set_and_check(rocRAND_TARGET_FILE ${PACKAGE_PREFIX_DIR}/lib/cmake/rocrand/rocrand-targets.cmake)

find_dependency(hip)

include(${CMAKE_CURRENT_LIST_DIR}/rocrand-fortran-config.cmake)

include(${rocRAND_TARGET_FILE})

set(rocRAND_LIBRARIES roc::rocrand)

set(rocRAND_LIBRARY roc::rocrand)
