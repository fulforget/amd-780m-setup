...
# from hipsolver-config.cmake.in
...
set_and_check(hipsolver_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)

set_and_check(hipsolver_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include)
...
set_and_check(hipsolver_TARGET_FILE ${PACKAGE_PREFIX_DIR}/lib/cmake/hipsolver/hipsolver-targets.cmake)

find_dependency(hip)

include(${hipsolver_TARGET_FILE})

set(hipsolver_LIBRARIES roc::hipsolver)
