...
# from rocsolver-config.cmake.in
...
set_and_check(rocsolver_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)

set_and_check(rocsolver_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include)
...
set_and_check(rocsolver_TARGET_FILE ${PACKAGE_PREFIX_DIR}/lib/cmake/rocsolver/rocsolver-targets.cmake)

find_dependency(hip)

find_dependency(rocblas)

include(${rocsolver_TARGET_FILE})

set(rocsolver_LIBRARIES roc::rocsolver)

set(rocsolver_LIBRARY roc::rocsolver)
