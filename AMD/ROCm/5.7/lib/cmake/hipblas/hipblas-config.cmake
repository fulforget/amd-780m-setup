...
set_and_check(hipblas_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)

set_and_check(hipblas_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include)
...
set_and_check(hipblas_TARGET_FILE ${PACKAGE_PREFIX_DIR}/lib/cmake/hipblas/hipblas-targets.cmake)

find_dependency(hip)

include(${hipblas_TARGET_FILE})
