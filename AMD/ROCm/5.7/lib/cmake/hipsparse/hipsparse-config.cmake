...
# from hipsparse-config.cmake.in
...
set_and_check(hipsparse_INCLUDE_DIR ${PACKAGE_PREFIX_DIR}/include)

set_and_check(hipsparse_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include)
...
set_and_check(hipsparse_TARGET_FILE ${PACKAGE_PREFIX_DIR}/lib/cmake/hipsparse/hipsparse-targets.cmake)

find_dependency(hip)

include(${hipsparse_TARGET_FILE})

set(hipsparse_LIBRARIES roc::hipsparse)
